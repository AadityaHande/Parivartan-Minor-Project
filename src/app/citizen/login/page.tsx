    ...
    try {
      ...
      try {
        await fetch('/api/auth/send-sms', {
          ...
          body: JSON.stringify({
            phoneNumber: registerPhone,
            message: `Welcome to Parivartan, ${registerName}! Your account has been created successfully. Report road issues, garbage, and citizen problems to make our city better!`,
          }),
        });
      } catch (smsError) {
      ...
      toast({
        ...
        description: "Welcome to Parivartan. An SMS has been sent to your phone.",
      });
      router.push('/citizen/dashboard');
    } catch (error: any) {
